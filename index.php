...
<head>
    ...
    <title>Login - Student Table</title>
    <style> 
    .btn-color{
...
<body>
    ...
    <div class="row">
      <div class="col-md-6 offset-md-3">
        <h2 class="text-center text-dark mt-5">WELCOM</h2>
        <div class="text-center mb-5 text-dark">Students Table </div>
        <div class="card my-5">

          <form class="card-body cardbody-color p-lg-5" method="POST">

            <div class="text-center">
              <img src="https://static.vecteezy.com/system/resources/previews/008/846/239/original/illustration-student-with-question-mark-png.png" class="img-fluid profile-image-pic img-thumbnail rounded-circle my-6"
